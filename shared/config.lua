Gang = {
    {
        GangName = "~y~Vagos~s~", -- Nom du Gang
        JobGangName = "vagos", -- Nom du set job Gang
        Couleurs = {R = 255, G = 255, B = 0}, --Couleurs markers/menus
        CouleursBlips = 5, --CouleursBlips 
        Garage = { -- Garage
            GradeJobAcces = {"pequeno", "asistente", "teniente", "soldado", "segundo", "boss"}, -- Grade du job qui a accès au garage
            PosDeleter = vector3(327.96, -2027.72, 21.07-0.92), -- Position du point pour ranger les véhicules
            PosSpawner = vector3(316.47, -2031.82, 20.56-0.92), -- Position du point sortir les véhicules
        ...
        BossAction = { -- Action Patron
            ...
            PosBoss = vector3(343.23, -2028.14, 22.35-0.92), -- Position du point action patron
        ...
        Coffre = { -- Coffre
            ...
            PosCoffre = vector3(332.28, -2018.77, 22.35-0.92), -- Position du point action patron
            SocietyCoffre = "society_vagos", -- Nom de la societe pour l'argent gang
        },
        Vestiaire = {
            GradeJobAcces = {"pequeno", "asistente", "teniente", "soldado", "segundo", "boss"}, -- Grade du job qui a accès aux actions patron
            PosVestiaire = vector3(325.96, -2050.70, 20.93-0.92), -- Position du point action patron
            Tenue = {
                {
                    Name = "Bras Droit",
                    Skin = {
    ...
    {
        GangName = "~p~Ballas~s~", -- Nom du Gang
        JobGangName = "ballas", -- Nom du set job Gang
        Couleurs = {R = 182, G = 0, B = 255}, --Couleurs markers/menus
        CouleursBlips = 27, --CouleursBlips 
        Garage = { -- Garage
            GradeJobAcces = {"habitants", "dealers", "bras", "boss"}, -- Grade du job qui a accès au garage
            PosDeleter = vector3(89.66, -1966.67, 20.74-0.92),-- Position du point pour ranger les véhicules
            PosSpawner =  vector3(102.78, -1958.81, 20.78-0.92),-- Position du point sortir les véhicules
            Vehicule = { -- Vehicule dans le garage
                -- Nom du véhicule / nom de spawn du véhicule / nombre de véhicule que peuvent sortir les personnes / hash du véhicule / couleur du véhicule
                {name = "Sultan", label = "sultan", stock = 2, hash = 970598228, color = {182, 0,255}},
                {name = "Bf400", label = "bf400", stock = 2, hash = 86520421, color = {182, 0,255}},
            },
        },
        BossAction = { -- Action Patron
            GradeJobAcces = {"boss"}, -- Grade du job qui a accès aux actions patron
            PosBoss = vector3(114.28, -1960.90, 21.33-0.92), -- Position du point action patron
        ...
        Coffre = { -- Coffre
            ...
            PosCoffre = vector3(117.70, -1944.10, 20.64-0.92), -- Position du point action patron
            SocietyCoffre = "society_ballas", -- Nom de la societe pour l'argent gang
        },
        Vestiaire = {
            GradeJobAcces = {"habitants", "dealers", "bras", "boss"}, -- Grade du job qui a accès aux actions patron
            PosVestiaire = vector3(113.30, -1974.04, 21.24-0.92), -- Position du point action patron
            Tenue = {
                {
                    Name = "OG",
                    Skin = {
    ...
    {
        GangName = "~b~Marabunta~s~", -- Nom du Gang
        JobGangName = "Marabunta", -- Nom du set job Gang
        Couleurs = {R = 182, G = 0, B = 255}, --Couleurs markers/menus
        CouleursBlips = 0, --CouleursBlips 
        Garage = { -- Garage
            GradeJobAcces = {"bleu", "confirme", "second", "chef"}, -- Grade du job qui a accès au garage
            PosDeleter = vector3(-1148.373, -1544.206, 4.30-0.92),-- Position du point pour ranger les véhicules
            PosSpawner = vector3(-1153.832, -1548.905, 4.25-0.92),-- Position du point sortir les véhicules
            Vehicule = { -- Vehicule dans le garage
                -- Nom du véhicule / nom de spawn du véhicule / nombre de véhicule que peuvent sortir les personnes / hash du véhicule / couleur du véhicule
                {name = "Sultan", label = "sultan", stock = 2, hash = 970598228, color = {255, 235, 52}},
                {name = "Bf400", label = "bf400", stock = 2, hash = 86520421, color = {255, 235, 52}},
        ...
        BossAction = { -- Action Patron
            ...
            PosBoss = vector3(-1150.27, -1513.474, 10.63-0.92), -- Position du point action patron
        ...
        Coffre = { -- Coffre
            ...
            PosCoffre = vector3(-1153.69, -1517.679, 10.63-0.92), -- Position du point action patron
