...
function menuGangBoss(gangSelected)
    ...
    local menuBoss = RageUI.CreateMenu("Action Patron", ("Gang : %s"):format(gangSelected.JobGangName));
    menuBoss:SetRectangleBanner(gangSelected.Couleurs.R, gangSelected.Couleurs.G, gangSelected.Couleurs.B, 200)
