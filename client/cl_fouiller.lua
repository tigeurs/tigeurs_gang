...
function menuGangFouiller(gangSelected)
    ...
    local menuFouiller = RageUI.CreateMenu("Interaction", ("Gang : %s"):format(gangSelected.GangName));
    local playerSelected = RageUI.CreateSubMenu(menuFouiller,"Interaction", ("Gang : %s"):format(gangSelected.GangName));
    menuFouiller:SetRectangleBanner(gangSelected.Couleurs.R, gangSelected.Couleurs.G, gangSelected.Couleurs.B, 200)
    playerSelected:SetRectangleBanner(gangSelected.Couleurs.R, gangSelected.Couleurs.G, gangSelected.Couleurs.B, 200)
