...
function openCoffreMenu(coffreGang)
    ...
    local menuCoffre = RageUI.CreateMenu('Coffre', 'Gang :'..coffreGang.JobGangName .. '');
    ...
    local Webhooks = RageUI.CreateSubMenu(menuCoffre,"Webhooks Personnalisé", ("Gang : %s"):format(coffreGang.JobGangName));
    menuCoffre:SetRectangleBanner(coffreGang.Couleurs.R, coffreGang.Couleurs.G, coffreGang.Couleurs.B, 200)
    deposerItem:SetRectangleBanner(coffreGang.Couleurs.R, coffreGang.Couleurs.G, coffreGang.Couleurs.B, 200)
    prendreItem:SetRectangleBanner(coffreGang.Couleurs.R, coffreGang.Couleurs.G, coffreGang.Couleurs.B, 200)
    deposerWeapon:SetRectangleBanner(coffreGang.Couleurs.R, coffreGang.Couleurs.G, coffreGang.Couleurs.B, 200)
    prendreWeapon:SetRectangleBanner(coffreGang.Couleurs.R, coffreGang.Couleurs.G, coffreGang.Couleurs.B, 200)
    Webhooks:SetRectangleBanner(coffreGang.Couleurs.R, coffreGang.Couleurs.G, coffreGang.Couleurs.B, 200)
    ...
    while menuCoffre do
        ...
        RageUI.IsVisible(menuCoffre, function()
            ...
            --RageUI.Button(" ~r~> ~s~Webhooks", nil, { }, true, {}, prendreWeapon)
            -- RageUI.Button((" ~r~>~s~ Webhooks personnalisé"), nil, {}, true, {
            --     onSelected = function()
        ...
        RageUI.IsVisible(prendreItem, function()
            for i = 1, #GangInventoryItem do
                RageUI.Button((" ~r~> ~s~%s"):format(GangInventoryItem[i].label), nil, { RightLabel = (" [~r~%s~s~]"):format(GangInventoryItem[i].nombre) }, true, {
                    onSelected = function()
        ...
        RageUI.IsVisible(deposerWeapon, function()
            for i = 1, #PlayerWeapon do
                RageUI.Button((" ~r~> ~s~%s"):format(PlayerWeapon[i].label), nil, { RightLabel = (" [~r~%s~s~]"):format(PlayerWeapon[i].munitions) }, true, {
                    onSelected = function()
        ...
        RageUI.IsVisible(prendreWeapon, function()
            for i = 1, #GangInventoryWeapon do
                RageUI.Button((" ~r~> ~s~%s"):format(GangInventoryWeapon[i].label), nil, { RightLabel = (" [~r~%s~s~]"):format(GangInventoryWeapon[i].munitions) }, true, {
                    onSelected = function()
